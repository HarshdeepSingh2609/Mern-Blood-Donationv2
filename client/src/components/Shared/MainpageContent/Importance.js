...
//     <div className='importance bg-light' style={{fontFamily:"sans-serif", marginBottom:"10px"}}>
//       <h3 className='text-center' style={{fontWeight:"bolder"}}>Why Donate Blood ?</h3>
//       <p className='text-center' >
//       Donating blood saves lives. It's a simple act of generosity with profound impact, offering hope to those in critical conditions.
//       <br />Blood donations are essential for surgeries, cancer treatments, and emergencies.
//       <br />There's no substitute for donated blood, making
//         every contribution invaluable.  </p>

//     <div className='bloodgps'>
//     <div className='bloodgp'>
//         <p >O+</p>
//     </div>
//     <div className='bloodgp'>
//         O-
...
// import { FaTint } from 'react-icons/fa'; // For blood drop icon
...
//         <strong>Donating blood saves lives.</strong> It's a simple act of generosity with profound impact,
//         offering hope to those in critical conditions. Blood donations are essential for surgeries,
//         cancer treatments, and emergencies. <strong>There's no substitute for donated blood</strong> —
//         every contribution is <strong>invaluable</strong>.
//       </p>
...
//         ❤️ Every <strong>2 seconds</strong>, someone needs blood. | 💉 <strong>1 donation</strong> can save
//         up to <strong>3 lives</strong>.
//       </div>
//     </div>
//   );
// };
